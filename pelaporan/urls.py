...
urlpatterns = [
    ...
    path('tamu_ajax/<int:uid>', views.get_tamu, name='ajax_users_detail'),
    path('pelanggaran_ajax/<int:uid>/<slug:tipe12>/<slug:sub>', views.get_pelanggaran, name = 'get_pelanggaran'),
